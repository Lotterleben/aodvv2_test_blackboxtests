...
func test_route_creation_0_to_3() {
    ...
    beginning.Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_sent_rreq, map[string]string{
    ...
    /* check node 1 */
    riot_line[1].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_received_rreq, map[string]string{
    ...
    riot_line[1].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_added_rt_entry, map[string]string{
        "Addr": beginning.Ip,
    ...
    riot_line[1].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_sent_rreq, map[string]string{
        "Orig_addr": beginning.Ip,
        "Targ_addr": end.Ip,
        "Orig_seqnum": "1",
        "Metric": "1",
    ...
    /* check node 2 */
    riot_line[2].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_received_rreq, map[string]string{
    ...
    riot_line[2].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_added_rt_entry, map[string]string{
        "Addr": beginning.Ip,
    ...
    riot_line[2].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_sent_rreq, map[string]string{
        "Orig_addr": beginning.Ip,
        "Targ_addr": end.Ip,
        "Orig_seqnum": "1",
        "Metric": "2",
    ...
    end.Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_received_rreq, map[string]string{
    ...
    end.Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_added_rt_entry, map[string]string{
        "Addr": beginning.Ip,
    ...
    end.Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_sent_rrep, map[string]string{
        "Next_hop": riot_line[2].Ip,
        "Orig_addr": beginning.Ip,
        "Orig_seqnum": "1",
        "Targ_addr": end.Ip,
    ...
    riot_line[2].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_received_rrep, map[string]string{
        "Last_hop": end.Ip,
        "Orig_addr": beginning.Ip,
        "Orig_seqnum": "1",
        "Targ_addr": end.Ip,
    ...
    riot_line[2].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_sent_rrep, map[string]string{
        "Next_hop": riot_line[1].Ip,
        "Orig_addr": beginning.Ip,
        "Orig_seqnum": "1",
        "Targ_addr": end.Ip,
    ...
    /* check node 1 */
    riot_line[1].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_received_rrep, map[string]string{
        "Last_hop": riot_line[2].Ip,
        "Orig_addr": beginning.Ip,
        "Orig_seqnum": "1",
        "Targ_addr": end.Ip,
    ...
    riot_line[1].Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_sent_rrep, map[string]string{
        "Next_hop": beginning.Ip,
        "Orig_addr": beginning.Ip,
        "Orig_seqnum": "1",
        "Targ_addr": end.Ip,
    ...
    beginning.Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_received_rrep, map[string]string{
        "Last_hop": riot_line[1].Ip,
        "Orig_addr": beginning.Ip,
        "Orig_seqnum": "1",
        "Targ_addr": end.Ip,
    ...
    beginning.Channels.Expect_JSON(make_JSON_str(mgmt.Tmpl_added_rt_entry, map[string]string{
        "Addr": end.Ip,
        "Next_hop": riot_line[1].Ip,
        "Seqnum": targ_seqnum,
        "Metric": "3",
...
func test_test_1() {
        mgmt.Create_clean_setup("test_test_1")
}

func test_test_2() {
        mgmt.Create_clean_setup("test_test_2")
}
